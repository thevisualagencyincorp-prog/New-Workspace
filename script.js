...
document.addEventListener('DOMContentLoaded', () => {
    ...
    titleBars.forEach(bar => {
        ...
        bar.addEventListener('mousedown', (e) => {
            ...
            // If it's a grid/flex item, switch to relative for dragging offset
            ...
            // Remember original transform rotation/position
            initialTransform = win.style.transform || '';
        ...
        document.addEventListener('mouseup', () => {
            if (isDragging) {
                isDragging = false;
                bar.style.cursor = 'grab';
                // Lock the new transform as the initial for next time
                initialTransform = win.style.transform;
            }
        });
    });
